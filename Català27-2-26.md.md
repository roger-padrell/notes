...
Frases fetes:
- **perdre l’esma** → quedar desconcertat, espantat o sense capacitat de reaccionar.
- **ser de la màniga ampla** → ser tolerant o permissiu, no gaire estricte.
- pesar figues → tenir molta son, començar a adormir-se (especialment quan el cap cau endavant).
- fer el paper de met → fer el ridícul o quedar malament davant dels altres.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MDEyODgyMCwxOTIzODgyOTg5LDE2OT
A4NDUzNTUsMTE3NzY4MDgyN119
-->